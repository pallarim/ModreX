...
class LSLObject(object):
    ...
    def llListenRemove(self,number):
        self.MyWorld.CS.SetScriptRunner(self.Id)
        self.MyWorld.CS.llListenRemove(number)
    def llSensor(self,name,id,type,range,arc):
        self.MyWorld.CS.SetScriptRunner(self.Id)
        self.MyWorld.CS.llSensor(name,id,type,range,arc)
    def llSensorRepeat(self,name,id,type,range,arc,rate):
        self.MyWorld.CS.SetScriptRunner(self.Id)
        self.MyWorld.CS.llSensorRepeat(name,id,type,range,arc,rate)
    def llSensorRemove(self):
        self.MyWorld.CS.SetScriptRunner(self.Id)
        self.MyWorld.CS.llSensorRemove()
    ...
    def llDetectedOwner(self,number):
        self.MyWorld.CS.SetScriptRunner(self.Id)
        return self.MyWorld.CS.llDetectedOwner(number)
    def llDetectedType(self,number):
        self.MyWorld.CS.SetScriptRunner(self.Id)
        return self.MyWorld.CS.llDetectedType(number)
    def llDetectedPos(self,number):
        self.MyWorld.CS.SetScriptRunner(self.Id)
        return self.MyWorld.CS.llDetectedPos(number)
    def llDetectedVel(self,number):
        self.MyWorld.CS.SetScriptRunner(self.Id)
        return self.MyWorld.CS.llDetectedVel(number)
    def llDetectedGrab(self,number):
        self.MyWorld.CS.SetScriptRunner(self.Id)
        return self.MyWorld.CS.llDetectedGrab(number)
    def llDetectedRot(self,number):
        self.MyWorld.CS.SetScriptRunner(self.Id)
        return self.MyWorld.CS.llDetectedRot(number)

    def llDetectedGroup(self,number):
        self.MyWorld.CS.SetScriptRunner(self.Id)
        return self.MyWorld.CS.llDetectedGroup(number)
    def llDetectedLinkNumber(self,number):
        self.MyWorld.CS.SetScriptRunner(self.Id)
        return self.MyWorld.CS.llDetectedLinkNumber(number)

    def llDie(self):
        self.MyWorld.CS.SetScriptRunner(self.Id)
        self.MyWorld.CS.llDie()
    ...
    def llGetTime(self):
        self.MyWorld.CS.SetScriptRunner(self.Id)
        return self.MyWorld.CS.llGetTime()

    def llResetTime(self):
        self.MyWorld.CS.SetScriptRunner(self.Id)
        self.MyWorld.CS.llResetTime()

    def llGetAndResetTime(self):
        self.MyWorld.CS.SetScriptRunner(self.Id)
        return self.MyWorld.CS.llGetAndResetTime()
    ...
    def llSetTimerEvent(self):
        print "llSetTimerEvent not implemented, use SetTimer instead"

    def llSleep(self):
        print "llSleep not implemented, not in use in Python!"
    ...
    def llParticleSystem(self,rules):
        self.MyWorld.CS.SetScriptRunner(self.Id)
        self.MyWorld.CS.llParticleSystem(rules)
